...
from accounts.forms import UserRegisterForm, UserLoginForm, CustomPasswordChangeForm, ProfileUpdateForm
...
class ProfileUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_object(self, queryset=None):
        # Ensure the user has a Profile object; create one if not
